      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/agriculture/special" element={<SpecialApplications />} />
            <Route path="/agriculture/soil" element={<SoilApplications />} />
            <Route path="/agriculture/foliar" element={<FoliarApplications />} />
            <Route path="/agriculture/drip" element={<DripApplications />} />
