...
const FilterSection = ({ 
  ...
  const toggleSection = (section: 'price' | 'availability' | 'features') => {
  ...
  return (
    <div className="space-y-6">
      ...
      {(filters.priceRanges.length > 0 || filters.availability.length > 0 || filters.features.length > 0 || searchQuery) && (
        <Button
          variant="outline"
          className="w-full border-green-200 text-green-700 hover:bg-green-50"
          onClick={() => {
            setFilters({ availability: [], priceRanges: [], features: [] });
            setSearchQuery('');
            // Clear URL parameter
...
const ProductCard = ({ 
  ...
  // Determine if product matches certain features for badges
  const isPowderForm = activeVariant.variant_type === 'weight' && activeVariant.unit === 'g';
  const isLiquidForm = activeVariant.variant_type === 'volume' && activeVariant.unit === 'ml';
  ...
  return (
    ...
    >
      <div className="relative flex-1">
        {/* Product Image */}
        <div className="relative h-48 overflow-hidden bg-gradient-to-br from-green-50 to-cyan-50">
          <img
            src={productImage}
            alt={product.name}
              ...
              {product.product_variants.map(v => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-200 ${
                    activeVariant.id === v.id ? "bg-green-600 scale-110" : "bg-gray-300 hover:bg-green-400"
                  }`}
                />
              ))}
            </div>
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-1">
            ...
            {isLiquidForm && (
              <Badge className="bg-cyan-500 text-white text-xs font-semibold">
                Liquid
              </Badge>
            )}
          </div>
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="relative h-96 rounded-lg overflow-hidden bg-gradient-to-br from-green-50 to-cyan-50">
  ...
  return (
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-cyan-50">
        {/* Header */}
        <div className="bg-gradient-to-r from-green-800 to-cyan-800 text-white py-12">
        ...
        {searchQuery && (
          <div className="container mx-auto px-4 pt-6">
            <div className="bg-white rounded-xl border border-green-200 p-4 mb-6 shadow-sm">
                ...
                {currentProducts.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-12">
                    <div className="max-w-md mx-auto">
                      <div className="w-24 h-24 bg-gradient-to-br from-green-100 to-cyan-100 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="fixed bottom-6 right-6 z-40">
          <div className="relative">
            <Link
              to="/cart"
              className="w-16 h-16 bg-gradient-to-br from-green-600 to-cyan-600 text-white rounded-full shadow-2xl flex items-center justify-center hover:shadow-xl transition-shadow"
            >
