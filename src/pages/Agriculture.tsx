...
const Agricultural = () => {
    ...
    const tabs = [
        {
            id: 'soil',
            label: 'Soil Applications',
            component: SoilApplications
        },
        {
            id: 'foliar',
            label: 'Foliar Applications',
            component: FoliarApplications
        },
        {
            id: 'drip',
            label: 'Drip Applications',
    ...
    return (
        <Layout>
            <div className="w-full">
                ...
                <div className="sticky top-[116px] md:top-[136px] z-30 bg-green-50/95 backdrop-blur border-b border-green-200 shadow-sm">
                                ...
                                {tabs.map((tab) => (
                                    <button
                                        ...
                                        className={`px-6 py-2.5 font-semibold text-sm whitespace-nowrap transition-all duration-200 border flex-shrink-0 rounded-full ${activeTab === tab.id
                                            ? 'text-green-800 border-green-500 bg-white shadow-md ring-1 ring-green-200'
                                            : 'text-green-700/80 border-transparent bg-white/60 hover:bg-white hover:text-green-800 hover:border-green-200'
                                            }`}
                                    >
                                        {tab.label}
                                    </button>
