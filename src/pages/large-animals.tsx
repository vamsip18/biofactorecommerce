...
const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="group bg-white rounded-lg border border-gray-200 hover:border-amber-300 hover:shadow-xl transition-all duration-300 cursor-pointer flex flex-col min-h-[520px]"
      onClick={onClick}
    >
