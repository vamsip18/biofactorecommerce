  ...
  const products: Product[] = [
    {
      id: 1,
      name: "Proceed -",
      description: "Advanced crop protection formulation for enhanced plant health",
      price: 1080.00,
      ...
      reviews: 145,
      isBestSeller: true,
      dosage: "500 ml per acre mixed with water",
      applicationTiming: "Preventive application at early growth stages",
      frequency: "Every 15-20 days during crop period"
    },
    {
      id: 2,
      name: "Native Neem - Natural Insecticide",
      description: "100% natural neem-based insecticide for organic farming",
      price: 866.00,
      ...
      applicationTiming: "Early morning or late evening application",
      frequency: "As per insect pressure, typically weekly intervals"
    },
    {
      id: 3,
      name: "Nutrition & Virnix",
      description: "Micronutrient blend for plant nutrition and virus protection",
      price: 1716.00,
      image: "https://images.unsplash.com/photo-1581235720708-87e772807c71?w=400&h=400&fit=crop",
      category: "Micronutrient + Protection",
      formulation: "Liquid Formulation",
      coverage: "300 ml per acre",
      features: [
        "Zinc 5%, Iron 2%, Manganese 2%, Boron 0.5%",
        "MAMS technology for better absorption",
        "Virus protection",
      ...
      applicationTiming: "At budding stage and flowering & fruiting stage",
      frequency: "Every 15 days in vegetable crops",
      advantages: [
        "Micronutrient deficiencies can be effectively prevented in all types of crops when infected with virus.",
        "Utilization efficiency is increased by keeping all types of micronutrients in small particles (MAMS technology) which can be quickly absorbed by the plant.",
        "Providing comprehensive micronutrients can lead to healthy foliar growth, more cover, stronger pods and higher quality yields."
      ]
    },
    {
      id: 4,
      name: "Bsl4 Agri",
      description: "Advanced biosecurity formulation for crop protection",
      price: 1333.00,
      originalPrice: 1500.00,
      image: "https://images.unsplash.com/photo-1573497019940-1c28c033a88e?w=400&h=400&fit=crop",
      category: "Biosecurity",
      formulation: "Wettable Powder",
      coverage: "From 200 g per acre",
      features: [
        "Advanced biosecurity technology",
        "Pathogen protection",
        "Systemic action",
        "Long-lasting effect"
      ],
      ...
      reviews: 128,
      isNew: true,
      dosage: "200-300 g per acre depending on disease pressure",
      applicationTiming: "Preventive application before disease onset",
      frequency: "Every 10-15 days during high-risk periods"
    }
  ];
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gradient-to-r from-green-900 to-green-900 text-white py-8">
          <div className="container mx-auto px-4">
            <h1 className="text-3xl md:text-4xl font-bold mb-2">Crop Protection</h1>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <main className="lg:w-3/4">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4 mb-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div>
                    ...
                    <h2 className="text-xl font-semibold text-gray-900">Crop Protection Products</h2>
                  </div>
              ...
              {/* Pagination (hidden since only 4 products) */}
              {totalPages > 1 && (
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                  ...
                  <div className="mt-12 pt-8 border-t border-gray-200">
                    ...
                    {/* Special Description for Nutrition & Virnix */}
                    {selectedProduct.id === 3 && (
                      <>
                        <p className="text-gray-600 mb-4 text-lg">
                          A liquid micronutrient blend containing zinc 5%, iron 2%, manganese 2% and boron 0.5%. Formulated using MAMS (Microbe Assisted Microsize Particle) technology.
                        </p>
                        <p className="text-gray-700 mb-8">
                          Micronutrient deficiencies in plants are more likely to occur as farmers do not follow comprehensive nutrition practices. So that the plants get affected by pests like insects or viruses. At such a time, by giving the plant complete micronutrients with high usable capacity in a short period of time, it again increases its strength and fights against pests like viruses. Nutrition is formulated for that.
                        </p>
                  ...
                  <div className="mt-12 pt-8 border-t border-gray-200 space-y-6">
                    ...
                    {selectedProduct.applicationTiming && (
                      <div>
                        ...
                        {/* Special timing for Nutrition & Virnix */}
                        {selectedProduct.id === 3 && (
                          <p className="text-gray-700 mt-2">
                            As soon as the micronutrient deficiency is observed, it should be applied to the plants by spraying. All crops should be sprayed once at the budding stage and once at flowering & fruiting stage. Better results can be obtained by spraying every 15 days in vegetable crops.
                          </p>
                        )}
                      </div>
                    )}
                    ...
                    {selectedProduct.frequency && (
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-3">How many times to use:</h4>
                        <p className="text-gray-700">{selectedProduct.frequency}</p>

                        {/* Special frequency for Nutrition & Virnix */}
                        {selectedProduct.id === 3 && (
                          <p className="text-gray-700 mt-2">
                            As soon as micronutrient deficiency is observed, it should be used twice in 10-15 days.
                          </p>
                        )}
                      </div>
                    )}
                  ...
                  {selectedProduct.id === 3 && (
                    <div className="mt-12 pt-8 border-t border-gray-200">
                      <h3 className="text-2xl font-bold text-gray-900 mb-4">MAMS Technology</h3>
                      <div className="bg-green-50 p-6 rounded-xl">
                        <p className="text-gray-700 mb-4">
                          Microbe Assisted Microsize Particle (MAMS) technology represents a breakthrough in micronutrient delivery:
                        </p>
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
                          <li>Nanoparticle size for maximum absorption</li>
                          <li>Microbe-assisted chelation for better stability</li>
                          <li>Enhanced mobility within plant tissues</li>
                          <li>95% utilization efficiency compared to 40-50% in conventional products</li>
                          <li>Reduced phytotoxicity and leaf burn</li>
                        </ul>
                      </div>
                    </div>
                  )}

                  {/* Special for Native Neem */}
                  {selectedProduct.id === 2 && (
                    <div className="mt-12 pt-8 border-t border-gray-200">
                      <h3 className="text-2xl font-bold text-gray-900 mb-4">Organic Neem Technology</h3>
                      <div className="bg-green-50 p-6 rounded-xl">
                        <p className="text-gray-700 mb-4">
                          Native Neem uses cold-pressed extraction technology to preserve all natural compounds:
                        </p>
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
                          <li>Contains Azadirachtin 3000 ppm (minimum)</li>
                          <li>Multiple mode of action against insects</li>
                          <li>Anti-feedant, repellent, and growth regulator properties</li>
                          <li>Safe for pollinators and beneficial insects</li>
                          <li>Zero waiting period for harvest</li>
                        </ul>
                      </div>
                    </div>
                  )}

                  {/* Special for Bsl4 Agri */}
                  {selectedProduct.id === 4 && (
                    <div className="mt-12 pt-8 border-t border-gray-200">
                      <h3 className="text-2xl font-bold text-gray-900 mb-4">Biosecurity Level 4 Technology</h3>
                      <div className="bg-green-50 p-6 rounded-xl">
                        <p className="text-gray-700 mb-4">
                          Bsl4 Agri incorporates advanced biosecurity technology for maximum protection:
                        </p>
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
                          <li>Multi-layer pathogen protection</li>
                          <li>Systemic and contact action</li>
                          <li>Rainfast within 1 hour of application</li>
                          <li>Compatible with integrated pest management</li>
                          <li>Reduced resistance development in pathogens</li>
                        </ul>
                      </div>
                    </div>
                  )}
