    ...
    <div className="space-y-6">
      ...
      <div className="border-t pt-4">
        ...
        >
          ...
          <ChevronDown className={`w-4 h-4 transition-transform ${
            expandedSections.diseaseTypes ? 'rotate-180' : ''
          }`} />
        </button>
...
const ProductCard = ({ 
  ...
  const diseaseTypeColors: Record<string, string> = {
    viral: 'bg-green-500',
    fungal: 'bg-green-600',
    bacterial: 'bg-green-700',
    preventive: 'bg-green-600',
    bioenhancer: 'bg-green-500',
    ...
    >
      <div className="relative flex-1">
        ...
        <div className="relative h-48 overflow-hidden bg-gradient-to-br from-green-50 to-white">
          ...
          >
            <Heart className="w-4 h-4 text-gray-600 hover:text-green-500" />
          </button>
        </div>
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="relative h-96 rounded-lg overflow-hidden bg-gradient-to-br from-green-50 to-white">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-green-700">Quality Guarantee</p>
                  <p className="text-sm text-gray-600">
