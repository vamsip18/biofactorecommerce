...
const FilterSection = ({
  ...
  const toggleSection = (section: 'price' | 'availability' | 'diseaseTypes' | 'special') => {
  ...
  return (
    <div className="space-y-6">
      ...
      {(filters.priceRanges.length > 0 || filters.availability.length > 0 || filters.diseaseTypes.length > 0 || filters.special.length > 0 || searchQuery) && (
        <Button
          variant="outline"
          className="w-full border-cyan-200 text-cyan-700 hover:bg-cyan-50"
          onClick={() => {
            setFilters({ availability: [], priceRanges: [], diseaseTypes: [], special: [] });
            setSearchQuery('');
            // Clear URL parameter
...
const ProductCard = ({
  ...
  const diseaseTypeColors: Record<string, string> = {
    viral: 'bg-cyan-500',
    fungal: 'bg-cyan-600',
    bacterial: 'bg-cyan-700',
    preventive: 'bg-cyan-600',
    bioenhancer: 'bg-cyan-500',
    general: 'bg-cyan-500'
  };
  // const badgeItems = [
  //   !isInStock
  ...
  return (
    ...
    >
      <div className="relative flex-1">
        {/* Product Image */}
        <div className="relative h-40 sm:h-48 overflow-hidden bg-gradient-to-br from-cyan-50 to-white">
          <img
            src={productImage}
            alt={product.name}
          ...
          >
            <Heart className="w-4 h-4 text-gray-600 hover:text-cyan-500" />
          </button> */}
        </div>
      ...
      <DialogContent className="max-w-2xl lg:max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
          ...
          <div className="space-y-4">
            <div className="relative aspect-square max-w-sm mx-auto rounded-lg overflow-hidden bg-gradient-to-br from-cyan-50 to-white">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="p-4 bg-cyan-50 rounded-lg">
              <div className="flex items-start gap-3 mb-3">
                <Truck className="w-5 h-5 text-cyan-600 mt-0.5 flex-shrink-0" />
                <div>
                  <p className="font-semibold text-cyan-700">Free Shipping</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-cyan-700">Quality Guarantee</p>
                  <p className="text-sm text-gray-600">
...
const DiseaseManagement = () => {
    ...
    const fetchProducts = async () => {
      try {
        ...
        const diseaseManagementProducts = (data || [])
          .map((product: any) => ({
            ...product,
            // Ensure collections is a single object, not an array
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 to-white">
      {/* Header */}
      <div className="bg-gradient-to-r from-cyan-800 to-cyan-900 text-white py-4 md:py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-xl md:text-4xl font-bold mb-1 md:mb-4">{t.pages.diseaseManagement}</h1>
            ...
            <div className="sticky top-[108px] z-20 bg-white rounded-xl border border-cyan-200 p-4 mb-4 shadow-sm lg:static lg:p-6 lg:mb-8">
              <div>
                <div>
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">{t.pages.allDiseaseManagement}</h2>
                </div>
              ...
              {currentProducts.length > 0 ? (
                ...
                <div className="col-span-full text-center py-12">
                  <div className="max-w-md mx-auto">
                    <div className="w-24 h-24 bg-gradient-to-br from-cyan-100 to-white rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        {mobileFiltersOpen && (
          <>
            ...
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-lg font-semibold">{t.common.filter}s</h2>
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <div className="relative">
          <Link
            to="/cart"
            className="w-16 h-16 bg-gradient-to-br from-cyan-600 to-cyan-700 text-white rounded-full shadow-2xl flex items-center justify-center hover:shadow-xl transition-shadow"
          >
            <ShoppingCart className="w-8 h-8" />
          </Link>
          {getCartCount() > 0 && (
            <span className="absolute -top-2 -right-2 bg-white text-cyan-600 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold animate-pulse border border-cyan-300">
              {getCartCount()}
            </span>
          )}
        </div>
